...
*/
	...
	always @( posedge sys_clk or negedge g_reset_n )
	begin
		...
		begin
			...
			begin
				case (g_aixs_data_index)
					0: x_signal <= g_ctrl_word[2];
					1: x_signal <= g_ctrl_word[1];
					2: x_signal <= g_ctrl_word[0];
					default: 
					begin
						if (g_aixs_data_index < 5'd19 )
						begin
						...
						begin
							x_signal <= ^{ g_ctrl_word, g_x_output }; // a parity bit(P, even parity)
						end
					end
				endcase
			end
